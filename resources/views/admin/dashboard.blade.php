                                ...
                                <div class="w-full md:flex md:justify-between md:space-x-5">
                                    ...
                                    <div
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div class="w-full flex justify-between">
                                                <div>
                                                    <img src="{{ asset('assets/imgs/custom-icons/wallet.png') }}"
                                    ...
                                    <div
                                        ...
                                        <div class="w-full div-url" role="button"
                                            ...
                                            <div class="w-full flex justify-between">
                                                <div>
                                                    <img src="{{ asset('assets/imgs/custom-icons/deposit.png') }}"
                                                        alt="wallet balance" width="40px" class="rounded-full">
                                                </div>
                                                <div class="w-full flex justify-end bg-gray-500 p-2 rounded ml-2">
                                    ...
                                    <div
                                        ...
                                        <div class="w-full div-url" role="button"
                                            ...
                                            <div class="w-full flex justify-between">
                                                <div>
                                                    <img src="{{ asset('assets/imgs/custom-icons/withdraw.png') }}"
                                                        alt="wallet balance" width="40px" class="rounded-full">
                                                </div>
                                                <div class="w-full flex justify-end bg-gray-500 p-2 rounded ml-2">
                                ...
                                <div class="w-full md:flex md:justify-between md:space-x-5">
                                    ...
                                    <div
                                        ...
                                        <div class="w-full div-url" role="button"
                                            ...
                                            <div class="w-full flex justify-between">
                                                <div>
                                                    <img src="{{ asset('assets/imgs/custom-icons/earning.png') }}"
                                                        alt="wallet balance" width="40px" class="rounded-full">
                                                </div>
                                                <div class="w-full flex justify-end bg-gray-500 p-2 rounded ml-2">
                                    ...
                                    <div
                                        ...
                                        <div class="w-full div-url" role="button"
                                            ...
                                            <div class="w-full flex justify-between">
                                                <div>
                                                    <img src="{{ asset('assets/imgs/custom-icons/invest.png') }}"
                                                        alt="wallet balance" width="40px" class="rounded-full">
                                                </div>
                                                <div class="w-full flex justify-end bg-gray-500 p-2 rounded ml-2">
                                    ...
                                    @if (websiteInfo('balance_transfer') == 'enabled' && isAddonEnabled('p2ptransfer'))
                                        ...
                                        <div
                                            ...
                                            <div class="w-full div-url" role="button"
                                                ...
                                                <div class="w-full flex justify-between">
                                                    <div>
                                                        <img src="{{ asset('assets/imgs/custom-icons/transfer.png') }}"
                                                            alt="wallet balance" width="40px" class="rounded-full">
                                                    </div>
                                                    <div class="w-full flex justify-end bg-gray-500 p-2 rounded ml-2">
                                                        <h2 class="font-lg">
                                                            {{ number_format(getTransfers()->where('status', 'pending')->count(),0) }}
                                                        </h2>
                                                    </div>
                                                </div>
                                ...
                                <div class="w-full md:flex md:justify-between md:space-x-5">
                                        ...
                                        <div
                                            ...
                                            <div class="w-full div-url" role="button"
                                                ...
                                                <div class="w-full flex justify-between">
                                                    ...
                                                    <div class="w-full flex justify-end bg-gray-500 p-2 rounded ml-2">
                                                        <h2 class="font-lg">{{ formatAmount(getLoans()->sum('amount')) }}
                                                        </h2>
                                                    </div>
                                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="w-full div-url" role="button"
                                            ...
                                            <div class="w-full flex justify-between">
                                                <div>
                                                    <img src="{{ asset('assets/imgs/custom-icons/referral.png') }}"
                                                        alt="wallet balance" width="40px" class="rounded-full">
                                                </div>
                                                <div class="w-full flex justify-end bg-gray-500 p-2 rounded ml-2">
                                    ...
                                    @if (isAddonEnabled('supportticket'))
                                        <div
                                            ...
                                            <div class="w-full div-url" role="button"
                                                ...
                                                <div class="w-full flex justify-between">
                                                    <div>
                                                        <img src="{{ asset('assets/imgs/custom-icons/ticket.png') }}"
                                                            alt="wallet balance" width="40px" class="rounded-full">
                                                    </div>
                                                    <div class="w-full flex justify-end bg-gray-500 p-2 rounded ml-2">
                                                        <h2 class="font-lg">{{ number_format(getTickets()->count(), 0) }}
                                                        </h2>
                                                    </div>
                                                </div>
