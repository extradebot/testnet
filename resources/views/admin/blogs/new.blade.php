                            ...
                            <div class="w-full flex items-center space-x-2">
                                ...
                                <label
                                    ...
                                    <span id="cover-image-preview"
                                        ...
                                        style="background-image: url({{ asset('assets/imgs/fallback.png') }}); background-size: contain; background-repeat: no-repeat;">
                                ...
                                <input class="hidden" type="file" accept="image/*" name="cover_image" id="cover_image"
                                    data-preview="cover-image-preview">
                            </div>
                            <span class="p-1 text-red-600">
                                @error('cover_image')
                                    {{ $message }}
