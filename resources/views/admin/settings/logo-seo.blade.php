                            ...
                            <div class="w-full flex items-baseline space-x-1">
                                ...
                                <label
                                    ...
                                    <span id="logo-preview" class="uploadIcon w-32 h-32  flex justify-center items-center"
                                        style="background-image: url({{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->logo) }}); background-size: contain; background-repeat: no-repeat;">
                            ...
                            <div class="w-full flex items-baseline space-x-1">
                                ...
                                <label
                                    ...
                                    <span id="logo-rec-preview"
                                        ...
                                        style="background-image: url({{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->logo_rec) }}); background-size: contain; background-repeat: no-repeat;">
                                        <span class="bg-gray-500 border p-2 text-white rounded-full">
                                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="w-full flex items-baseline space-x-1">
                                ...
                                <label
                                    ...
                                    <span id="favicon-preview" class="uploadIcon w-16 h-16 flex justify-center items-center"
                                        style="background-image: url({{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->favicon) }}); background-size: contain; background-repeat: no-repeat;">
                                        <span class="bg-gray-500 border p-2 text-white rounded-full">
                            ...
                            <div class="w-full flex items-baseline space-x-1">
                                ...
                                <label
                                    ...
                                    <span id="banner-preview"
                                        ...
                                        style="background-image: url({{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->banner) }}); background-size: contain; background-repeat: no-repeat;">
                                        <span class="bg-gray-500 border p-2 text-white rounded-full">
