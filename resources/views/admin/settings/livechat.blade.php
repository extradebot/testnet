        ...
        <div class="w-full flex justify-center">
            <div class="w-11/12 rounded-sm bg-[#0e1726] p-1 md:p-4">
                ...
                <div class="p-2 md:p-4">
                    <form class="mt-2 p-2 md:p-4" action="{{ route('admin.settings.livechat-validate') }}" method="post"
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm mb-3">
                            <div class="w-full">
                                ...
                                <div class="flex mt-1 items-center">
                                    <label for="livechat"
                                        class="hidden-radio toggle @if (old('livechat') ?? websiteInfo('livechat') == 'enabled') toggle--on @else toggle--off @endif"></label>
                                    <input type="hidden" name="livechat" id="livechat"
                                        @if (old('livechat') ?? websiteInfo('livechat') == 'enabled') value="enabled" @else value="disabled" @endif
                                        required>
                                </div>
                            </div>
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm mb-3">
                            <div class="w-full">
                                ...
                                <div class="flex mt-1 items-center">
                                    <label for="whatsapp"
                                        class="hidden-radio toggle @if (old('whatsapp') ?? $whatsapp->status == 'enabled') toggle--on @else toggle--off @endif"></label>
                                    <input type="hidden" name="whatsapp" id="whatsapp"
                                        @if (old('whatsapp') ?? $whatsapp->status == 'enabled') value="enabled" @else value="disabled" @endif
                                        required>
                                </div>
                            </div>
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full">
                                ...
                                <input
                                    ...
                                    type="number" name="whatsapp_no" id="whatsapp_no"
                                    value="{{ old('whatsapp_no') ?? $whatsapp->no }}" required>
                            </div>
                            <span class="p-1 text-red-600">
                                @error('whatsapp_no')
                                    {{ $message }}
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full">
                                ...
                                <textarea
                                    class="w-full pt-2 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                                    cols="30" rows="7" name="whatsapp_message" id="whatsapp_message" required>{!! old('whatsapp_message') ?? $whatsapp->message !!}</textarea>
                            </div>
                            <span class="p-1 text-red-600">
