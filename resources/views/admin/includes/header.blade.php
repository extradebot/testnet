...
<head>
    ...
    {{-- Styles --}}
    {{-- primary style --}}
    <link href="{{ asset('assets/themes/cryptic/style/styles.css?v2.0.4') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/themes/' . websiteInfo('theme') . '/style/bgs.css') }}" rel="stylesheet"
        type="text/css">
    ...
    <link href="{{ asset('codemirror/lib/codemirror.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('codemirror/theme/cobalt.css') }}" rel="stylesheet" type="text/css">
                ...
                <div class="">
                    <a href="#">
                        <img class="rounded-sm w-8 md:w-16"
                            src="{{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->logo) }}" alt="">
                    </a>
                </div>
