...
<head>
    ...
    <link href="{{ asset('assets/themes/' . websiteInfo('theme') . '/style/styles.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/themes/' . websiteInfo('theme') . '/style/animate.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">

    {{-- Alpine js (deferred)  --}}
    <script defer src="{{ asset('assets/scripts/alpine3.js') }}"></script>
