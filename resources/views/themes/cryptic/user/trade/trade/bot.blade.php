                                                    ...
                                                    <tr>
                                                        <td class="align-middle">
                                                            <img class="crypt-star pr-1" alt="star"
                                                                src="{{ asset('assets/imgs/crypto-svg-icons/' . strtolower(str_replace('_USDT', '', $price->symbol)) . '.svg') }}"
                                                                width="15">
                                                            <a
                                                    ...
                                                    <tr>
                                                        <td class="align-middle">
                                                            <img class="crypt-star pr-1" alt="star"
                                                                ...
                                                                width="15">
                                                            <a
                                                                href="{{ url('/user/trading/trade/bot/' . str_replace('_', '/', $price->symbol)) }}">{{ str()->replace('_', '/', $price->symbol) }}</a>
                                                        </td>
                                                        <td>
                                                            <span class="d-block">
                                                                {{ $price->price }}
                    ...
                    <div class="">
                        <div class="crypt-boxed-area">
                            <h6 class="crypt-bg-head">
                                <b>{{ ct('BOT', 'u') }} </b><b class="crypt-up">{{ ct('BUY', 'u') }}</b> / <b
                                    class="crypt-down">{{ ct('SELL', 'u') }}</b>

                            </h6>

                            <ul class="nav nav-tabs">
                                <li role="presentation"><a href="#market" class="active"
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-md-12">
                                                <div class="crypt-buy-sell-form">
                                                    <p>{{ ct('Available') }}: <span class="crypt-up"><span
                                                                class="quote_bal">
                                                                @if ($quote)
                                                                ...
                                                                @else
                                                                    0.00000000
                                                                @endif
                                                            </span> {{ $symbol_2 }}</b></span></span> <span
                                                    ...
                                                    <div class="crypt-buy">
                                                        @if (session()->has('success'))
                                                            <div class="alert alert-success alert-dismissible fade show text-white bg-success"
                                                                role="alert">
                                                                <strong>{{ ct('Success') }}!</strong>
                                                                {{ session()->get('success') }}
                                                        ...
                                                        @elseif(session()->has('fail'))
                                                            <div class="alert alert-danger alert-dismissible fade show text-white bg-danger"
                                                                role="alert">
                                                                <strong>{{ ct('Error') }}!</strong>
                                                                {{ session()->get('fail') }}
                                                                <button type="button" class="close"
                                                                    data-dismiss="alert" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                        ...
                                                        @if ($bot_status)
                                                            <input type="hidden" name="selected_bot_id"
                                                                id="selected_bot_id" value="{{ $running_bot->id }}">
                                                            <div class="bot">
                                                                <div class="">
                                                                    <img src="{{ asset('assets/imgs/' . $running_bot->icon) }}"
                                                                        alt="bot" width="35px"
                                                                ...
                                                                <div class="px-3">
                                                                    <span
                                                                        class="btn btn-success rounded">{{ ct('RUNNING', 'u') }}</span>
                                                                </div>
                                                        ...
                                                        @else
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend"> <span
                                                                        class="input-group-text">{{ ct('BOT') }}</span>
                                                                </div>
                                                                <input type="hidden" name="selected_bot_id"
                                                                    id="selected_bot_id">
                                                                <input type="text" class="form-control"
                                                                    placeholder="choose bot" readonly
                                                                    id="selected_bot_name">
                                                                <div class="input-group-append"> <span
                                                                        class="input-group-text"
                                                                        id="bot-change-button">{{ ct('Change') }}</span>
                                                                </div>
                                                            </div>
                                                        @endif
                                                        ...
                                                        @if ($bot_status)
                                                            <div class="menu-green order-button" data-type="stop"><a
                                                                    href=""
                                                                    class="crypt-button-red-full">{{ ct('Stop Bot') }}</a>
                                                            </div>
                                                        @else
                                                            <div class="menu-green order-button" data-type="start"><a
                                                                    href=""
                                                                    class="crypt-button-green-full">{{ ct('Start Bot') }}</a>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                        ...
                        <div>
                            <ul class="nav nav-tabs">
                                ...
                                <li role="presentation"><a href="#closed-orders"
                                        data-toggle="tab">{{ ct('Bot History') }}</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                            ...
                                            <tbody>
                                                @foreach ($bot_history as $history)
                                                    <tr>
                                                        ...
                                                        <td
                                                            @if ($history->type == 'credit') class="crypt-up" @else class="crypt-down" @endif>
