                                    ...
                                    @if ($trades->count() > 0)
                                        @foreach ($trades->where('status', 'active') as $trade)
                                            <div
                                                ...
                                                <div>
                                                    <a href="{{ route('user.trading.demo.trade', ['symbol1' => explode('_', $trade->pair)[0], 'symbol2' => explode('_', $trade->pair)[1]]) }}"
                                                        class="end-trade flex space-x-1 bg-orange-500 px-2 py-1 rounded hover:bg-gray-600">{{ ct('End Trade') }}</a>
                                                </div>
                                        ...
                                        @foreach ($trades->where('status', '!=', 'active') as $trade)
                                            <div
                                                ...
                                                <div
                                                    class="@if ($trade->status == 'win') text-green-500 @else text-red-500 @endif">
                                                    {{ ct($trade->status) }}
                                                </div>
                                    ...
                                    @else
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <img src="{{ asset('assets/trading/images/empty.png') }}" alt="no-orders">
                                            </div>
