                                            ...
                                            @if (str()->endsWith($price->symbol, 'BTC'))
                                                @if (file_exists(root_path() .
                                                    ...
                                                    <tr>
                                                        <td class="align-middle">
                                                            <img class="crypt-star pr-1" alt="star"
                                                                src="{{ asset('assets/imgs/crypto-svg-icons/' . strtolower(str_replace('_BTC', '', $price->symbol)) . '.svg') }}"
                                                                width="15">
                                                            <a
                                                                href="{{ url('/user/trading/demo/' . str_replace('_', '/', $price->symbol)) }}">{{ str()->replace('_', '/', $price->symbol) }}</a>
                                                        </td>
                    ...
                    <div class="">
                        <div class="crypt-boxed-area">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li role="presentation"><a href="#limit" class="active"
                                        data-toggle="tab">{{ ct('Limit') }}</a>
                                </li>
                                            ...
                                            <div class="crypt-buy-sell-form">
                                                <p>{{ ct('Buy') }} <span class="crypt-up"
                                                        ...
                                                        class="fright">{{ ct('Available') }}: <b
                                                            class="crypt-up"><span class="quote_bal">
                                                                @if ($quote)
                                            ...
                                            <div class="crypt-buy-sell-form">
                                                <p>{{ ct('Buy') }} <span
                                                        ...
                                                        class="fright">{{ ct('Available') }}: <b class="crypt-up">
                                                            <span class="quote_bal" id="quote_bal">
                                                                @if ($quote)
                                                                    {{ number_format($quote->balance, 8) ?? 0 }}
                                                                @else
                                                                    0.00000000
