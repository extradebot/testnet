        ...
        <div class="flex justify-center w-full h-screen items-center">
            <div class="w-full md:w-3/4 lg:w-2/6 cred-hyip-theme1-primary-card">
                ...
                <form action="{{ route('email-verify-resend-validate') }}" method="POST"
                    class="px-4 lg:px-10 mt-6 space-y-6">
                    @csrf
                    <div class="grid grid-cols-1">
                        <div class="relative">
                            ...
                            <input type="email" name="email" placeholder="{{ ct('Email') }}"
                                class="cred-hyip-theme1-text-input" value="{{ old('email') }}">
                            <span>
                                @error('email')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="grid grid-cols-1 mt-5">
                        <div class="relative">
                            ...
                            <input type="submit" value="{{ ct('Resend Verification Link') }}"
                                class="cred-hyip-theme1-primary-btn">
                        </div>
                    </div>
                </form>
                {{-- Form end --}}
