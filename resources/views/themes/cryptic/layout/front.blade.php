...
<head>
    ...
    <link href="{{ asset('assets/themes/cryptic/style/styles.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/themes/cryptic/style/bgs.css') }}" rel="stylesheet">
...
<body>
    ...
    <footer class="hero-section bg-[#0e1726] text-white border-t-1">
        ...
        {{-- particle js --}}
        <script src="{{ asset('assets/scripts/particle.js') }}"></script>
        <script>
            particlesJS.load('particles-js', '{{ asset('assets/scripts/particlejs-config.json') }}', function() {
