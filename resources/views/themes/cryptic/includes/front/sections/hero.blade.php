                    ...
                    <div class="w-full grid grid-cols-1 lg:grid-cols-2">
                        <div class="pl-20 sm-pl-5 pr-6 z-10">
                            <h1 data-aos="fade-up" data-aos-duration="3000"
                                class="mt-28 capitalize text-6xl sm-font-6 font-bold">{!! json_decode($section->content)->section_heading !!}</h1>

                            <div data-aos="fade-up" data-aos-duration="3000"
                                class="mt-10 font-semibold text-xl sm-font-4">
                        ...
                        <div class="relative h-[48rem] -top-44 bg-no-repeat hidden lg:flex" data-aos="fade-up"
                        ...
                        <div class="h-6 lg:hidden">
                            <img style="z-index: 0" class="relative  -right-28 -sm-100 -md-150"
                                src="{{ asset('assets/imgs/' . json_decode($section->content)->section_bg_img) }}"
                                alt="">
                        </div>
                    </div>
                </div>
