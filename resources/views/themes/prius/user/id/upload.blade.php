            ...
            <div class="w-11/12 rounded-md bg-[#0e1726] p-2 md:p-4">
                ...
                <div class="w-full p-6 md:p-10 flex justify-center">
                    <div class="w-full flex space-x-2 rounded-lg bg-[#131d2c] text-[#d3d6df] p-2 md:p-4 text-xs md:text-sm">
                        ...
                        <div>
                            <b class="font-medium">{{ ct('DISCLOSURE') }}: </b>
                            {{ ct('You are about to start your account verfication. If any of the gray out fields do not reflect your intended value,') }}
                            <a href="{{ route('user.account.edit') }}">{{ ct('CLICK HERE') }}</a>
                            {{ ct('to edit your account before proceeding.') }}
                            <br> <br>
                            <button id="start-button" type="button"
                                class="w-1/3 text-xs md:text-sm text-[#d1d5db] text-center px-5 py-2 bg-[#1b2e4b] hover:bg-gray-700 rounded-md">
                                {{ ct('START NOW') }}
                            </button>
                        </div>
                    ...
                    <div>
                        <div class="text-[#bfc9d4] text-xs md:text-sm mb-1">
                            <div class="w-full flex items-baseline space-x-1">
                                <label class="font-medium w-28 overflow-hidden"
                                    for="first_name">{{ ct('First Name') }}:</label>
                                <input
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full flex items-baseline space-x-1">
                                <label class="font-medium w-28 overflow-hidden"
                                    for="last_name">{{ ct('Last Name') }}:</label>
                                <input
                                    class="flex-grow px-2 md:px-4 pt-4 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full flex items-baseline space-x-1">
                                ...
                                <input
                                    class="flex-grow px-2 md:px-4 pt-4 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                                    type="text" name="gender" id="gender" value="{{ user('gender') }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full flex items-baseline space-x-1">
                                <label class="font-medium w-28 overflow-hidden"
                                    for="marital_status">{{ ct('Marital Status') }}:</label>
                                <div class="flex-grow pt-4">
                                    <div>
                                        <select
                                            class="w-full px-2 md:px-4 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                                    ...
                                    <div>
                                        <small
                                            class="text-red-500 text-xs">{{ ct('This field needs your attention', 'l') }}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full flex items-baseline space-x-1">
                                ...
                                <input
                                    class="flex-grow px-2 md:px-4 pt-4 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                                    type="text" name="dob" id="dob" value="{{ user('dob') }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full flex items-baseline space-x-1">
                                <label class="font-medium w-28 overflow-hidden"
                                    for="country">{{ ct('Nationality') }}:</label>
                                <input
                                    class="flex-grow px-2 md:px-4 pt-4 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                ...
                <div class="w-11/12 rounded-md bg-[#0e1726] p-2 md:p-4">
                    ...
                    <div>
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full flex items-baseline space-x-1">
                                <label class="font-medium w-28 overflow-hidden"
                                    for="country">{{ ct('Address') }}:</label>
                                <input
                                    class="flex-grow px-2 md:px-4 pt-4 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                                    type="text" name="address" id="address" value="{{ user('street_address') }}"
                                    disabled>
                            </div>
                        </div>
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full flex items-baseline space-x-1">
                                <label class="font-medium w-28 overflow-hidden"
                                    for="addrstateess">{{ ct('State') }}:</label>
                                <input
                                    class="flex-grow px-2 md:px-4 pt-4 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                                    type="text" name="state" id="state" value="{{ user('state') }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full flex items-baseline space-x-1">
                                <label class="font-medium w-28 overflow-hidden"
                                    for="phone_no">{{ ct('Phone No') }}:</label>
                                <input
                                    class="flex-grow px-2 md:px-4 pt-4 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                                    type="text" name="phone_no" id="phone_no" value="{{ user('phone_no') }}"
                                    disabled>
                            </div>
                        </div>
                        ...
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full flex items-baseline space-x-1">
                                <label class="font-medium w-28 overflow-hidden"
                                    for="email">{{ ct('Email') }}:</label>
                                <input
                                    class="flex-grow px-2 md:px-4 pt-4 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                                    type="text" name="email" id="email" value="{{ user('email') }}" disabled>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full flex justify-center">
                <div class="w-11/12 rounded-md bg-[#0e1726] p-2 md:p-4">
                    ...
                    <div>
                        <div class="text-[#bfc9d4] text-xs md:text-sm">
                            <div class="w-full flex items-baseline space-x-1">
                                <label class="font-medium w-32 overflow-hidden"
                                    for="id_type">{{ ct('Id Document Type') }}:</label>
                                <select
                                    class="flex-grow pt-4 px-2 md:px-4 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500"
                        ...
                        <div class="w-full flex items-baseline space-x-1">
                            ...
                            <div class="lg:flex-grow pt-4 lg:flex items-center space-x-2">
                                <div class="w-full lg:w-1/3">
                                    ...
                                    <input class="hidden attachment-input" type="file" name="front_id" id="front_id"
                                        data-preview="front-preview" accept="image/png, image/jpg, image/jpeg" required>
                                </div>

                                <div class="attachment-list w-full lg:w-2/3"></div>
                                <div><img id="front-preview" class="hidden"
                                        src="{{ asset('assets/imgs/placeholder.png') }}" alt=""></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="w-full flex items-baseline space-x-1">
                            ...
                            <div class="lg:flex-grow pt-4 lg:flex items-center space-x-2">
                                <div class="w-full lg:w-1/3">
                                    ...
                                    <input class="hidden attachment-input" type="file" name="back_id" id="back_id"
                                        data-preview="back-preview" accept="image/png, image/jpg, image/jpeg" required>
                                </div>

                                <div class="attachment-list w-full lg:w-2/3"></div>
                                <div><img id="back-preview" class="hidden"
                                        src="{{ asset('assets/imgs/placeholder.png') }}" alt=""></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="w-full flex items-baseline space-x-1">
                            ...
                            <div class="lg:flex-grow pt-4 lg:flex items-center space-x-2">
                                <div class="w-full lg:w-1/3">
                                    ...
                                    <input class="hidden attachment-input" type="file" name="selfie" id="selfie"
                                        accept="image/png, image/jpg, image/jpeg" data-preview="selfie-preview" required>
                                </div>

                                <div class="attachment-list w-full lg:w-2/3"></div>
                                <div><img id="selfie-preview" class="hidden"
                                        src="{{ asset('assets/imgs/placeholder.png') }}" alt=""></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        <div align="left">
                            <button type="button" value="0"
                                class="back-button text-xs md:text-sm text-[#d1d5db] text-center px-5 py-2 bg-[#1b2e4b] hover:bg-gray-700 rounded-md">
                        ...
                        <div align="right">
                            <button type="button" value="1"
                                class="next-button text-xs md:text-sm text-[#d1d5db] text-center px-5 py-2 bg-[#1b2e4b] hover:bg-gray-700 rounded-md">
