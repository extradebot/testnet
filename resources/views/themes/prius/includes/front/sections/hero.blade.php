        ...
        <div class="container">
            <div class="banner__wrapper d-flex align-items-center justify-content-between">
                ...
                <div class="banner__thumb d-none d-lg-block">
                    {{-- <img src="{{ asset('assets/themes/prius/assets/images/banner/thumb.png') }}" alt="banner"> --}}
                    <img width="100%" src="{{ asset('assets/imgs/' . json_decode($section->content)->section_bg_img) }}"
                        alt="image">
                    <div class="shapes">
                        <img src="{{ asset('assets/themes/prius/assets/images/banner/big-coin.png') }}" alt="banner"
                            class="shape shape1">
                        <img src="{{ asset('assets/themes/prius/assets/images/banner/light.png') }}" alt="banner"
                            class="shape shape2">
                        <img src="{{ asset('assets/themes/prius/assets/images/banner/sm-coin.png') }}" alt="banner"
                            class="shape shape3">
                        <img src="{{ asset('assets/themes/prius/assets/images/banner/sm-coin.png') }}" alt="banner"
                            class="shape shape4">
                    </div>
