@foreach ($view_data['sections']->where('name', 'breadcrumb') as $section)
    <div class="inner-banner section-bg overflow-hidden">
        ...
        <div class="shapes">
            <img src="{{ asset('assets/themes/prius/assets/images/banner/inner-bg.png') }}" alt="banner"
                class="shape shape1">
            <img src="{{ asset('assets/themes/prius/assets/images/banner/inner-thumb.png') }}" alt="banner"
