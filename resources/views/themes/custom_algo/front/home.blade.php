...
<head>
    ...
    <link href="{{ asset('assets/themes/custom_algo/assets/output.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/themes/custom_algo/style/bgs.css') }}" rel="stylesheet">
    ...
    <div class="bg-[#0e1726] text-white w-full h-full m-0 p-0">
        ...
        <div class="bg-[#0e1726] w-full pr-3 pl-1 lg:pr-4 lg:pl-4 flex justify-between items-center z-40 sticky top-0">
            <div class="lg:flex lg:space-x-5 lg:items-center">
                <!-- Logo -->
                <div>
                    <img src="{{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->logo_rec) }}" alt="logo">
                </div>
            ...
            <section id="hero">
                <div class="w-full grid grid-cols-2">
                    ...
                    <div class="hero-img hidden lg:block h-full w-full overflow-hidden">
                        <img src="{{ asset('assets/imgs/' . json_decode($section->content)->section_bg_img) }}"
                            alt="hero" class="lg:object-contain">
                    </div>
                    <div class="hero-img lg:hidden w-full  bg-cover bg-no-repeat"
                        style="background: url({{ asset('assets/imgs/' . json_decode($section->content)->section_bg_img) }})">
                    </div>
                </div>
            </section>
        @endforeach
            ...
            <section id="why">
                <div
                    ...
                    <div class="self-center">
                        <img src="{{ asset('assets/themes/custom_algo/assets/imgs/buy_sell.png') }}"
                            alt="Buy and sell">
                    </div>
        ...
        <section>
            ...
            <div class="mt-10 grid grid-cols-5 lg:grid-cols-7 gap-5 px-8 lg:px-16">
                ...
                @foreach (['btc', 'eth', 'ltc', 'doge', 'trx', 'ada', 'xrp', 'bnb', 'usdc', 'usdt', 'matic', 'dai', 'sol', 'atom'] as $image)
                    <img src="{{ asset('assets/imgs/crypto-svg-icons/' . $image . '.svg') }}" loading="lazy"
        ...
        <section>
            ...
            <div class="w-full px-8 lg:px-16">
                <img src="{{ asset('assets/themes/custom_algo/assets/imgs/full.png') }}"
