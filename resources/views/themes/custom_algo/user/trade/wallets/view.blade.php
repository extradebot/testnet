                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="hidden lg:block relative w-full">
                                                <div
                                                    class="absolute flex justify-center items-center -top-7 -right-7 h-9 w-9 rounded-full bg-blue-600 text-white">
                                                    @if (file_exists(root_path() . 'public/assets/imgs/crypto-svg-icons/' . strtolower($wallet->symbol) . '.svg'))
                                                        <img src="{{ asset('assets/imgs/crypto-svg-icons/' . strtolower($wallet->symbol) . '.svg') }}"
                                                            alt="{{ $wallet->name }}" class="rounded-full">
                                                    @else
                                            ...
                                            <div>
                                                <div>
                                                    <h2 class="text-sm lg:text-base font-semibold">
                                                        {{ number_format($wallet->balance, 8) }}</h2>
                                                </div>
                                                <div class="mt-2">
                                            ...
                                            <div class="lg:hidden opacity-50">
                                                <div
                                                    class="flex justify-center items-center h-9 w-9 rounded-full bg-blue-600 text-white">
                                                    @if (file_exists(root_path() . 'public/assets/imgs/crypto-svg-icons/' . strtolower($wallet->symbol) . '.svg'))
                                                        <img src="{{ asset('assets/imgs/crypto-svg-icons/' . strtolower($wallet->symbol) . '.svg') }}"
                                                            alt="{{ $wallet->name }}" class="rounded-full">
                                                    @else
                            ...
                            <div class="wallet-section">
                                <div class="w-full  rounded-md bg-[#0e1726] text-[#d3d6df] p-2 md:p-4">
                                    <div
                                        ...
                                        <div class="mt-3 mb-3">
                                            <a role="button" data-action="fund"
                                        ...
                                        <div class="mt-3 mb-3">
                                            <a role="button" data-action="withdraw"
                                                class="wallet-trigger flex justify-start items-center space-x-1 text-xs md:text-sm text-[#d1d5db] text-center px-5 py-2 my-2 bg-[#1b2e4b] hover:bg-gray-700 rounded-md">
                                    ...
                                    @foreach (tradingWallet() as $wallet)
                                        <div
                                            ...
                                            <div class="inline-flex space-x-3 md:space-x-5">
                                                <a role="button"
                                                    data-href="{{ route('user.trading.wallets.view', $wallet->address) }}"
                                                    class="wallet_link">
        ...
        $("#funding-amount").on('input', function() {
            ...
            if (action_type == 'fund') {
                if (funding_amount > curren_bal) {
                    $('#funding-current-balance').removeClass('text-green-600').addClass('text-red-600').fadeOut(
                        100).fadeIn(100).fadeOut(100).fadeIn(100);
                    $('#funding-submit').hide();
                } else {
                ...
                if (funding_total > coin_bal) {
                    $('#coin-balance').removeClass('text-green-600').addClass('text-red-600').fadeOut(100).fadeIn(
