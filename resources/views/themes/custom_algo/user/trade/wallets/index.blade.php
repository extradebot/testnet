        ...
        <div class="w-full flex justify-center">
            <div class="w-11/12 rounded-sm bg-[#0e1726] p-1 md:p-4">
                <div class="flex justify-end">
                    <div>
                        <a role="button" data-toggle="create-wallet-form" title="Create New Trading Wallet"
                            class="popup-trigger-button flex justify-start items-center space-x-1 text-xs md:text-sm text-[#d1d5db] text-center px-5 py-2 my-2 bg-[#1b2e4b] hover:bg-gray-700 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="2">
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-medium">
                                                @if (file_exists(root_path() . 'public/assets/imgs/crypto-svg-icons/' . strtolower($currency->symbol) . '.svg'))
                                                    <img src="{{ asset('assets/imgs/crypto-svg-icons/' . strtolower($currency->symbol) . '.svg') }}"
                                                        alt="{{ $currency->name }}" width="50px" class="rounded-full">
                                                @else
                                                    <img src="{{ asset('assets/imgs/fallback.png') }}"
                                                        alt="{{ $currency->name }}" width="50px" class="rounded-full">
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <a role="button" data-symbol="{{ $currency->symbol }}"
                                                    class="create-wallet-btn flex justify-start items-center space-x-1 text-xs md:text-sm text-[#d1d5db] text-center px-5 py-2 my-2 bg-[#1b2e4b] hover:bg-gray-700 rounded-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110">
                    ...
                    <div class="w-full p-6 md:p-10 flex justify-center">
                        <div
                            ...
                            <div>
                                ...
                                {{ ct("You haven't added any wallet.") }}
                            </div>
                        </div>
                    </div>
                @endif
