...
<head class="crypt-dark">
    ...
    <meta property="og:image" content="{{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->banner) }}">
    {{--  Twitter --}}
    ...
    <meta property="twitter:image" content="{{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->banner) }}">
    <meta name="robots" content="noindex">
    <meta name="robots" content="none">

    {{--  Favicon --}}
    <link rel="apple-touch-icon" href="{{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->favicon) }}">
    <link rel="icon" href="{{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->favicon) }}">
    <meta name="msapplication-TileColor" content="#060818">
    <meta name="theme-color" content="#060818">


    {{-- assets starts --}}
    <link rel="stylesheet" href="{{ asset('assets/trading/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/trading/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/trading/css/icons.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/trading/css/ui.css') }}">
</head>
...
<body class="crypt-dark" id="body">
                        ...
                        <div class="row">
                            <div class="col-xs-2">
                                <div class="crypt-logo"><img
                                        src="{{ asset('assets/imgs/' . json_decode(websiteInfo('meta'))->logo_rec) }}"
                                        alt=""></div>
                            </div>
                            <div class="col-xs-2">
        ...
        <div class="row sm-gutters">
                                    ...
                                    <tbody class="crypt-table-hover">
                                        @foreach ($prices as $price)
                                            @if (str()->endsWith($price->symbol, 'BTC'))
                                                @if (file_exists(root_path() .
                                                            'public/assets/imgs/crypto-svg-icons/' .
                                                            strtolower(str_replace('_BTC', '', $price->symbol)) .
                                                            '.svg'))
                                                    <tr>
                                                        <td class="align-middle">
                                                            <img class="crypt-star pr-1" alt="star"
                                    ...
                                    <tbody class="crypt-table-hover">
                                        @foreach ($prices as $price)
                                            @if (str()->endsWith($price->symbol, 'ETH'))
                                                @if (file_exists(root_path() .
                                                            'public/assets/imgs/crypto-svg-icons/' .
                                                            strtolower(str_replace('_ETH', '', $price->symbol)) .
                                                            '.svg'))
                                                    <tr>
                                                        <td class="align-middle">
                                                            <img class="crypt-star pr-1" alt="star"
                                                                src="{{ asset('assets/imgs/crypto-svg-icons/' . strtolower(str_replace('_ETH', '', $price->symbol)) . '.svg') }}"
                                                                width="15">
                                                            <a
                                                                href="{{ url('/user/trading/trade/' . str_replace('_', '/', $price->symbol)) }}">{{ str()->replace('_', '/', $price->symbol) }}</a>
                                                        </td>
                                    ...
                                    <tbody class="crypt-table-hover">
                                        @foreach ($prices as $price)
                                            @if (str()->endsWith($price->symbol, 'TRX'))
                                                @if (file_exists(root_path() .
                                                            'public/assets/imgs/crypto-svg-icons/' .
                                                            strtolower(str_replace('_TRX', '', $price->symbol)) .
                                                            '.svg'))
                                                    <tr>
                                                        <td class="align-middle">

                                                            <img class="crypt-star pr-1" alt="star"
                                                                src="{{ asset('assets/imgs/crypto-svg-icons/' . strtolower(str_replace('_TRX', '', $price->symbol)) . '.svg') }}"
                                                                width="15">
                                                            <a
                                                                href="{{ url('/user/trading/trade/' . str_replace('_', '/', $price->symbol)) }}">{{ str()->replace('_', '/', $price->symbol) }}</a>
                                                        </td>
                                            ...
                                            @if (str()->endsWith($price->symbol, 'USDD'))
                                                @if (file_exists(root_path() .
                                                    ...
                                                    <tr>
                                                        <td class="align-middle">
                                                            <img class="crypt-star pr-1" alt="star"
                                                                src="{{ asset('assets/imgs/crypto-svg-icons/' . strtolower(str_replace('_USDD', '', $price->symbol)) . '.svg') }}"
                                                                width="15">
                                                            <a
                                                                href="{{ url('/user/trading/trade/' . str_replace('_', '/', $price->symbol)) }}">{{ str()->replace('_', '/', $price->symbol) }}</a>
                                                        </td>
                    ...
                    <div class="">
                        <div class="crypt-boxed-area">
                            <h6 class="crypt-bg-head">
                                <b class="crypt-up">{{ ct('BUY', 'u') }}</b> / <b
                                    class="crypt-down">{{ ct('SELL', 'u') }}</b>

                            </h6>

                            <ul class="nav nav-tabs">
                                <li role="presentation"><a href="#limit" data-toggle="tab"
                                        class="active">{{ ct('Limit') }}</a>
                                </li>
                                <li role="presentation"><a href="#market" data-toggle="tab">{{ ct('Market') }}</a>
                                </li>
                                ...
                                <div role="tabpanel" class="tab-pane" id="market">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-6">
                                            <div class="crypt-buy-sell-form">
                                                <p>{{ ct('Sell') }} <span
                                                        class="crypt-down">{{ $symbol_1 }}</span> <span
                                                        class="fright">{{ ct('Available') }}: <b
                                                            class="crypt-down"><span class="base_bal" id="base_bal">
                                                                @if ($base)
                                                ...
                                                <div class="crypt-sell">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text"><input type="checkbox"
                                                                class="toggle-tp" data-toggle="market-sell-tp"
                                                                checked>{{ ct('TP/SL', 'u') }}</span>
                                                    ...
                                                    <div class="order-button" data-order="market" data-type="sell"><a
                                                            href=""
                                                            class="crypt-button-red-full">{{ ct('Sell/Short') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="limit">
                                    <div class="row no-gutters">
                                        <div class="col-md-6">
                                            <div class="crypt-buy-sell-form">
                                                <p>{{ ct('Buy') }} <span
                                                        class="crypt-up">{{ $symbol_1 }}</span> <span
                                                        class="fright">Available: <b class="crypt-up"> <span
                                                ...
                                                <div class="crypt-buy">
                                                    ...
                                                    <div class="order-button" data-order="limit" data-type="buy"><a
                                                            href=""
                                        ...
                                        <div class="col-md-6">
                                            <div class="crypt-buy-sell-form">
                                                <p>{{ ct('Sell') }} <span
                                                        class="crypt-down">{{ $symbol_1 }}</span> <span
                                                        class="fright">{{ ct('Available') }}: <b class="crypt-down">
                                                            <span class="base_bal">
                                                                @if ($base)
                                                ...
                                                <div class="crypt-sell">
                                                    ...
                                                    <div class="order-button" data-order="limit" data-type="sell"><a
                                                            href=""
                                                            class="crypt-button-red-full">{{ ct('Sell') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-md-6">
                                            <div class="crypt-buy-sell-form">
                                                <p>{{ ct('Buy') }} <span
                                                        class="crypt-up">{{ $symbol_1 }}</span> <span
                                                        class="fright">{{ ct('Available') }}: <b class="crypt-up">
                                                            <span class="quote_bal">
                                                                @if ($quote)
                                                                    {{ number_format($quote->balance, 8) ?? 0 }}
                                                                @else
                                                                    0.00000000
                                        ...
                                        <div class="col-md-6">
                                            <div class="crypt-buy-sell-form">
                                                <p>{{ ct('Sell') }} <span
                                                        class="crypt-down">{{ $symbol_1 }}</span> <span
                                                        class="fright">{{ ct('Available') }}: <b
                                                            class="crypt-down"><span class="base_bal">
                                                                @if ($base)
                                                                    {{ number_format($base->balance, 8) ?? 0 }}
                                                                @else
                                                                    0.00000000
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 col-xxl-2">
                <div class="crypt-market-status mt-4">
                    <div>
                        <ul class="nav nav-tabs">
                            <li role="presentation"><a href="#history" class="active"
                                    data-toggle="tab">{{ ct('history') }}</a>
                            </li>
                            <li role="presentation"><a href="#market-trading"
                                    data-toggle="tab">{{ ct('market trading') }}</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                    ...
                    <div class="crypt-market-status">
                        <div>
                            <ul class="nav nav-tabs">
                                ...
                                <li role="presentation"><a href="#closed-orders"
                                        data-toggle="tab">{{ ct('Closed Orders') }}</a>
                                </li>
                                <li role="presentation"><a href="#balance"
                                        data-toggle="tab">{{ ct('Balance') }}</a></li>
                            </ul>
                            <div class="tab-content">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @else
                                            <div class="no-orders text-center">
                                                <img src="{{ asset('assets/trading/images/empty.png') }}"
                                                    alt="no-orders">
                                            </div>
                                        @endif
                                    </table>
    ...
    <script src="{{ asset('assets/trading/amc/core.js') }}"></script>
    <script src="{{ asset('assets/trading/amc/charts.js') }}"></script>
    <script src="{{ asset('assets/trading/amc/dark.js') }}"></script>
    <script src="{{ asset('assets/trading/amc/animated.js') }}"></script>
    <script src="{{ asset('assets/trading/js/jquery.js') }}"></script>
    <script src="{{ asset('assets/trading/js/popper.min.js') }}"></script>
    <script src="{{ asset('assets/trading/bootstrap/js/bootstrap.bundle.js') }}"></script>
    <script src="{{ asset('assets/trading/bootstrap/js/bootstrap.js') }}"></script>
    <script src="{{ asset('assets/trading/js/main.js') }}"></script>
    <script src="{{ asset('assets/trading/js/amc.js') }}"></script>
