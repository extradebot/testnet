    ...
    <div>
        <div>
            <div>
                ...
                <div>
                    <div>
                        <img src="{{ asset('assets/imgs/custom-icons/wallet.png') }}" alt="wallet balance" width="40px">
                    </div>
                    <div>
                        <div>
                            <div>
                ...
                <div>
                    <div>
                        <img src="{{ asset('assets/imgs/custom-icons/deposit.png') }}" alt="deposits" width="40px">
                    </div>
                    <div>
                        <div>
                            <div>
                ...
                <div>
                    <div>
                        <img src="{{ asset('assets/imgs/custom-icons/withdraw.png') }}" alt="withdrawals" width="40px">
                    </div>
                    <div>
                        <div>
                            <div>
            ...
            <div>
                ...
                <div>
                    <div>
                        <img src="{{ asset('assets/imgs/custom-icons/earning.png') }}" alt="withdrawals" width="40px">
                    </div>
                    <div>
                        <div>
                            <div>
                ...
                <div>
                    <div>
                        <img src="{{ asset('assets/imgs/custom-icons/invest.png') }}" alt="investments" width="40px">
                    </div>
                    <div>
                        <div>
                            <div>
                ...
                @if (websiteInfo('balance_transfer') == 'enabled' && isAddonEnabled('p2ptransfer'))
                    ...
                    <div>
                        <div>
                            <img src="{{ asset('assets/imgs/custom-icons/transfer.png') }}" alt="transfers" width="40px">
                        </div>
                        <div>
                            <div>
                                <div>
            ...
            <div>
                @if (websiteInfo('loan') == 'enabled' && isAddonEnabled('cryptoloan'))
                    ...
                    <div>
                        <div>
                            <img src="{{ asset('assets/imgs/custom-icons/loan.png') }}" alt="loans" width="40px">
                        </div>
                        <div>
                            <div>
                                <div>
                ...
                <div>
                    <div>
                        <img src="{{ asset('assets/imgs/custom-icons/referral.png') }}" alt="referrals" width="40px">
                    </div>
                    <div>
                        <div>
                            <div>
                ...
                @if (isAddonEnabled('supportticket'))
                    <div>
                        <div>
                            <img src="{{ asset('assets/imgs/custom-icons/ticket.png') }}" alt="transfers" width="40px">
                        </div>
                        <div>
                            <div>
                                <div>
