    ...
    <div class="w-full flex justify-center">
        <div class="w-5/6 md:w-3/4 mt-7">
            <div class="w-full bg-[#5457b6] p-3 md:p-5 h-[29rem] md:h-[26rem] overflow-y-scroll">
                ...
                <div class="w-full flex justify-center">
                    <div class="w-20 h-20 bg-white rounded-full">
                        <img src="{{ asset('assets/imgs/logo.png') }}" alt="img" class="min-h-full min-w-full">
                    </div>
                </div>
                ...
                <div class="w-full text-[#dae0f5] p-2 md:p-5">
                    ...
                    <p class="font-medium text-sm md:text-base pl-6">
                        Thank you for purchasing a copy of CredHYIP, the best HYIP management script in the market. This
                        script was carefully crafted by Traders for Traders.
                        <br>
                        Before proceeding to install this script, kindly <a class="text-lg underline hover:text-[#324152]"
                            href="https://credcrypto.net">visit</a> to activate your copy and get your license key. Each
                        purchase can only be used to activate a single license key. Beware that you can only use this script
                        on a single domain at time
                        <br>
                        For support and existence, <a class="text-lg underline hover:text-[#324152]"
                            href="https://credcrypto.net">visit</a> and create a support ticket.
                    </p>
                ...
                <div class="w-full md:flex md:justify-evenly space-y-3 md:scroll-py-0 text-[#dae0f5] p-5">
                    ...
                    <div class="md:w-1/3">
                        ...
                        <div class="font-medium text-sm md:text-base pl-5">
                            <ul class="list-disc">
                                <li>Resell, distribute, give away, or trade by any means to any third party or individual.
                                </li>
                ...
                <div class="w-full text-[#dae0f5] p-5">
                    <div class="w-full flex space-x-1 items-center">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-orange-400 animate-pulse"
                    ...
                    <p class="font-medium text-sm md:text-base pl-6">
                        We will not be responsible for any issues or error that occurs as a result of your modification of
                        our code and/ database
                    </p>
                </div>
            </div>
            <div class="mt-6 float-right">
                {{-- Next button --}}
                <div>
                    <a href="{{ route('install.server') }}"
                        class="trigger flex justify-center items-center cursor-pointer bg-[#5457b6] hover:bg-[#c3c4ef] text-white font-semibold h-10 md:h-16 w-10 md:w-16 rounded-full">
