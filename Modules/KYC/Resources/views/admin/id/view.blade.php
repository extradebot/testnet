                    ...
                    <table
                        ...
                        <tbody class="p-2 md:p-4">
                                    ...
                                    <div class="flex space-x-2 items-center">
                                        <div>
                                            @if (adminUser($id_document->user_id, 'id_verified') == 'verified')
                                                <h6
                                                    class="h-3 w-3 rounded-full animate-pulse bg-green-500 shadow-lg shadow-green-300">
                                                </h6>
                                            ...
                                            @elseif (adminUser($id_document->user_id, 'id_verified') == 'rejected')
                                                <h6
                                                    class="h-3 w-3 rounded-full animate-pulse bg-red-600 shadow-lg shadow-red-400">
                                                </h6>
                                            @elseif (adminUser($id_document->user_id, 'id_verified') == 'pending')
                                                <h6
                                                    class="h-3 w-3 rounded-full animate-pulse bg-gray-500 shadow-lg shadow-gray-300">
                                                </h6>
                                            @endif
                                        </div>
                                        <div>
                                            {{ adminUser($id_document->user_id, 'first_name') }}
                                            {{ adminUser($id_document->user_id, 'last_name') }}
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <form action="{{ route('admin.id.delete', $id_document->id) }}" method="post"
                                    id="{{ 'deleteIdForm' . $id_document->id }}">
                                    @csrf
                                </form>
                            </tr>
                        </tbody>
        ...
        $(document).ready(function() {
            $("#frontId").click(function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.open("{{ asset('storage/id') . '/' . $id_document->front_id }}",
                            '_blank').focus();
        ...
        $(document).ready(function() {
            $("#backId").click(function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.open("{{ asset('storage/id') . '/' . $id_document->back_id }}",
                            '_blank').focus();
        ...
        $(document).ready(function() {
            $("#selfie").click(function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.open("{{ asset('storage/id') . '/' . $id_document->selfie }}", '_blank')
                            .focus();
