                        ...
                        <tbody width="100%">
                            @foreach ($wallets as $wallet)
                                <tr>
                                    ...
                                    <td>
                                        @if (file_exists(root_path() . 'public/assets/imgs/crypto-svg-icons/' . strtolower($wallet->symbol) . '.svg'))
                                            <img src="{{ asset('assets/imgs/crypto-svg-icons/' . strtolower($wallet->symbol) . '.svg') }}"
                                                alt="{{ $wallet->name }}" width="50px" class="rounded-full">
                                        @else
                                            <img src="{{ asset('assets/imgs/fallback.png') }}" alt="{{ $wallet->symbol }}"
                                    ...
                                    <form action="{{ route('admin.trading.wallets.delete', $wallet->id) }}"
                                        id="{{ 'deleteWalletForm' . $wallet->id }}" method="POST">
                                        <td class="inline-flex space-x-3 md:space-x-5">

                                            @csrf

                                            <a href="{{ route('admin.wallets.view', $wallet->id) }}"
