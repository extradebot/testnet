        ...
        <div class="w-full flex justify-center">
            <div class="w-11/12 rounded-sm bg-[#0e1726] p-1 md:p-4">
                ...
                <div class="flex justify-end space-x-3">
                    <div>
                        <a role="button" data-type="open"
                            class="new-button flex justify-start items-center space-x-1 text-xs md:text-sm text-[#d1d5db] text-center px-5 py-2 my-2 bg-[#1b2e4b] hover:bg-gray-700 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="2">
                    ...
                    <div>
                        <a role="button" data-type="activate"
                            class="new-button flex justify-start items-center space-x-1 text-xs md:text-sm text-[#d1d5db] text-center px-5 py-2 my-2 bg-[#1b2e4b] hover:bg-gray-700 rounded-md">
                        ...
                        <tbody width="100%">
                            @foreach ($bots as $bot)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('assets/imgs/' . $bot->icon) }}" alt="{{ $bot->name }}"
                                    ...
                                    <td class="flex justify-space-around">
                                        <a role="button" class="new-button" data-type="edit"
                                            data-bot_id="{{ $bot->id }}" data-name="{{ $bot->name }}"
                                            data-price="{{ $bot->price }}" data-status="{{ $bot->status }}"
                                        ...
                                        <a href="{{ route('admin.trading.trading-bots.delete', $bot->id) }}"
                                            class="text-red-600">
                                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
